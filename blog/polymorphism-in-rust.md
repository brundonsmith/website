...
A Rust trait can be used to constrain a type parameter in a generic function (or
...
We can mix and match structs here because all of their data is behind pointers,
